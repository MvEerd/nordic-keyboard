...
// Define GPIO pins for columns and rows. TODO uncomment this section for the
// left keyboard half.
...
static void adv_init(void) {
	...
	// maximum? always use maximum? iirc minimum power consumption difference.
...
static void send_hid_bitmap(uint8_t *data) {
	// TODO TODO TODO queue? explain why there is no error check here.
...
int main(void) {
	// TODO TODO TODO set regout0 to 1.8V instead of using default 3.3V.
	...
	// Enable DC/DC regular to reduce energy consumption. TODO TODO TODO
	// enabling dcdc0 doesn't actually reduce power consumption.
